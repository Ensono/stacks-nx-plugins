...
describe('workspace generator', () => {
    ...
    it('installs dependencies with preferred package manager', async () => {
        (detectPackageManager as Mock).mockImplementationOnce(() => 'yarn');
    ...
    it('runs generators with preferred package manager', async () => {
        (getCommandVersion as Mock).mockImplementation(() => '7.0.0');
        (detectPackageManager as Mock).mockImplementation(() => 'pnpm');

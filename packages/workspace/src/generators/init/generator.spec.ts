...
describe('init generator', () => {
    ...
    describe('README.md file', () => {
        it('should change the generated by text', async () => {
            await generator(tree, {
                ...options,
                eslint: false,
                commitizen: false,
        ...
        it('should change the command heading', async () => {
            await generator(tree, {
                ...options,
                eslint: false,
                commitizen: false,
        ...
        it('should have the nx build command in the readme', async () => {
            await generator(tree, {
                ...options,
                eslint: false,
                commitizen: false,
            ...
            expect(readmeFile).toContain('nx build <project> <...options>');
        });
        ...
        it('should have the nx serve command in the readme', async () => {
            await generator(tree, {
                ...options,
                eslint: false,
                commitizen: false,
            ...
            expect(readmeFile).toContain('nx serve <project> <...options>');
        });

        it('should have the nx test command in the readme', async () => {
            await generator(tree, {
                ...options,
                eslint: false,
                commitizen: false,
            ...
            expect(readmeFile).toContain('nx test <project> <...options>');
        });
    });

...
The root `eslint.config.mjs` file exported by `@ensono-stacks/workspace:init`:
 ...
 * @example
 * // eslint.config.mjs
 * import stacksConfig from './eslint.config.mjs';
...
```javascript
// eslint.config.mjs (generated by @ensono-stacks/workspace:init)
...
Project-level `eslint.config.mjs` files extend the root config:
...
```javascript
// apps/<next-app>/eslint.config.mjs
import baseConfig from '../../eslint.config.mjs';
import { defineConfig } from 'eslint/config';
